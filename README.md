...
|[spring-boot-security/spring-boot-springsecurity-userdb](https://github.com/zhengjian511/spring-boot-samples/tree/master/spring-boot-security/spring-boot-springsecurity-userdb)|Spring Boot 整合 Spring Security（用户名密码角色配置-数据库）|
