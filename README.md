...
|[spring-boot-security/spring-boot-springsecurity-method](https://github.com/zhengjian511/spring-boot-samples/tree/master/spring-boot-security/spring-boot-springsecurity-method)|Spring Boot 整合 Spring Security（方法安全配置）|
