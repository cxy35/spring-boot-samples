...
class SpringBootRabbitmqApplicationTests {
    ...
    public void direct() {
        // 会发送到指定的队列
        rabbitTemplate.convertAndSend(RabbitMQDirectConfig.QUEUE_NAME_DIRECT, "Hello RabbitMQDirect...");
    }
    ...
    public void header() {
        ...
        rabbitTemplate.send(RabbitMQHeaderConfig.EXCHANGE_NAME_HEADER, null, nameMsg);
        rabbitTemplate.send(RabbitMQHeaderConfig.EXCHANGE_NAME_HEADER, null, nameMsg2);
        rabbitTemplate.send(RabbitMQHeaderConfig.EXCHANGE_NAME_HEADER, null, ageMsg);
    }
}
